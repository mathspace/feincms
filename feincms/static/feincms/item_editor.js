...
(function($){
    ...
    function save_content_type_selects() {
        $('#main_feincms>.panel').each(function() {
    ...
    $(document).ready(function($){
        ...
        create_tabbed('#main_feincms_wrapper', '#main_feincms', function(tab_str){
        ...
        var errors = $('#main_feincms div.errors');
        ...
        if(errors.length) {
            ...
            $('#main_feincms_wrapper>div.navi_tab:first-child').trigger('click');
        }
    });
